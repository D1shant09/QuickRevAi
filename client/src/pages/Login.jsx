...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ background: '#222831', color: '#EEEEEE' }}>
            {/* Background Orbs */}
            <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full blur-[120px] pointer-events-none" style={{ background: 'rgba(0,173,181,0.15)' }}></div>
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full blur-[120px] pointer-events-none" style={{ background: 'rgba(0,173,181,0.10)' }}></div>
            ...
            <div className="w-full max-w-md backdrop-blur-xl p-8 rounded-2xl shadow-2xl relative z-10 transition-transform duration-500 hover:scale-[1.01]" style={{ background: '#393E46', border: '1px solid rgba(0,173,181,0.2)' }}>
                ...
                <h2 className="text-3xl font-bold mb-2 text-center" style={{ color: '#00ADB5' }}>Welcome Back</h2>
                <p className="text-center mb-8" style={{ color: 'rgba(238,238,238,0.6)' }}>Sign in to continue to QuickRev AI</p>
                ...
                <p className="mt-8 text-center text-sm" style={{ color: 'rgba(238,238,238,0.5)' }}>
                    Don't have an account? <Link to="/register" className="font-medium transition-colors hover:underline" style={{ color: '#00ADB5' }}>Register now</Link>
                </p>
            </div>
        </div>
    );
